...
export default function BlogLanding() {
    return (
        <div className="flex justify-center">
            <div className="flex flex-col md:flex-row space-y-10 md:space-y-0 md:justify-between w-full">
                <div className="space-y-10">
                    <div className={`${poppinsFont.className} font-bold text-4xl xl:text-6xl space-y-1`}>
                        {/*{"Thoughts on Code, Design, and Other Stuff"}*/}
                        <div className="animate-fade-down animate-delay-[200ms]">{"Thoughts on Code, Design,"}</div>
                        <div className="opacity-90 animate-fade-down animate-delay-[400ms]">{"and Other Stuff"}</div>
                    </div>
                    <div>
                        <div
                            className="md:w-4/5 xl:w-1/2 text-lg xl:text-2xl text-gray-600 animate-fade animate-delay-[1000ms]">
                    ...
                    <Card isHoverable isPressable
                        ...
                        <CardFooter className="flex flex-col !items-start z-10">
                            <div className="flex flex-row text-blue-500">
                                <ScrollShadow hideScrollBar={true} className="space-x-2 max-w-[200px] xl:max-w-[300px]"
